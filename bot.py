...
async def requestHandler(bot:Update, msg:Message):
    ...
    for document in documents:
        try:
           ...
           replyText = f"<b>👋 හායි   {mentionUser} !!\n\n📍 ඔබගේ ඉල්ලීම වන  {contentRequested} අපවෙත ලැබී ඇත.\n\n🚀 එක දිනකදී ඔබට ඉල්ලීම් එකක් පමණක් සිදු කල හැක \n📌 තව ඉල්ලීම් ඇත්නම් එය හෙට ලබා දෙන්න.උපසිරස ඇතුලත් චිත්‍රපට ලබා දීමට ඉතා විශාල වෙහෙසක් මහන්සියක් හා කාලයක් ගතවන බැවින් අප හා අමනාප නොවී එය ලබා දෙන තුරු රැදී සිටින්න .\n\nදින 7 ක් ඇතුලත එය පිළිබද කිසිදු ප්‍රතිචාරයක් නොලැබුනේ නම් ඇඩ්මින් දැනුවත් කරන්න </b>"
