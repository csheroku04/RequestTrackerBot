            ...
            if key == "_id":
                ...
                if document[key][0] != channelID:
                    ...
                    if user.status not in ("administrator", "creator"): # If accepting, rejecting request tried to be done by neither admin nor owner
                        ...
                        if data == "reject":
                            result = "REJECTED"
                            groupResult = " (👈Type කල යුතු ආකාරය) ඔය විදිහට ටයිප් කරලා @CineSubzChatNew එකට දාල ලින්ක්  එක ගන්න.\nආයේ හරියට නම දාන්න Try කරන්න කරුණාකරලා.🙂\n\n ඔයාට දැන් නැවත ෆිල්ම් එකක් ඉල්ලන්න හැකියාව ලබාදී ඇත.\n ගැටළුවක් ඇත්නම් @CineSubzAdminBot අපිට කියන්න."
                            ...
                            result = "REJECTED"
                            groupResult = "TVSeries අවශ්‍ය නම් @cinesubztvseriesrequestbot වෙතට යොමු කරන්න. මෙහි පැමිණ ඉල්ලීමෙන් වලකින්න..😞\n\n ඔයාට දැන් නැවත ෆිල්ම් එකක් ඉල්ලන්න හැකියාව ලබාදී ඇත.\n ගැටළුවක් ඇත්නම් @CineSubzAdminBot අපිට කියන්න."
                            button = InlineKeyboardButton("ඉල්ලීම අසම්පුර්ණයි🚫", "rejected")
                        elif data == "rulebrake":
                            result = "REJECTED"
                            groupResult = "මමේක සයිට් එකේ තියන එකක් ඒ නිසා ඉල්ලන්න කලින් @CineSubzChatnew Group එකේ Search කරලා ගන්න  ෆිල්ම් එක. එකෙන් හොයා ගන්න බැරි උනොත් විතරක්  ඉලන්න. කරුණාකරලා.😞\n\n ඔයාට දැන් නැවත ෆිල්ම් එකක් ඉල්ලන්න හැකියාව ලබාදී ඇත.\n ගැටළුවක් ඇත්නම් @CineSubzAdminBot අපිට කියන්න"
                            button = InlineKeyboardButton("ඉල්ලීම අසම්පුර්ණයි🚫", "rejected")
